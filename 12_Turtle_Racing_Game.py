"""
Description: This is a Turtle racing game.
Author: Dongok Yang
Date: 2023.12.05 ~ 12.06
"""
...
print(speedlist)
if winner == user_bet:
    Trackmaker.write("You win", align="center", font=("Arial", 24, "normal"))
else:
    T1.write("You lose", align="center", font=("Arial", 24, "normal"))
screen.exitonclick()